دوستان فعلا از این روش استفاده نکنید ؛‌سیستم فیلترینگ دست بکار شده و دامنه حالت اتومات رو پیاده کرده و بعد از یه مدت پورتی که کلود فلیر به ایران وصل میشه رو بلاک میکنه ؛ با دامنه شخصی (بهترین دامنه ir هست) میتونید استفاده کنید
