نکته مهم: نیازی نیست منتظر پیاده سازی این پروژه بمونید ؛ تونل معکوس وب سوکت با cdn توسط این [پروژه](https://github.com/jpillora/chisel) ممکن است ؛ ازش استفاده کنید 
