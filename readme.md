...
دوستان یه یکی دو روز اپدیت نداریم ؛‌ باید بکوبم از نو بسازم
...
ولی پیشناهاد میکنم خودش ایپی رو پیدا کنه و اگه پینگ بالا بود برنامه رو ری استارت کنید (هم ایران و خارج ری استارت کنید نه فقط خارج)

# مهم

# دامنه حالت auto توسط فیلتر چی بسته شد؛ اگه سرور ایرانتون در شبکه همراه باشه با حالت auto وصل نمیشید یا کیفیت اتصال و پینگ بدی بهتون میده ؛ یا باید از دامنه شخصی استفاده کنید یا صبر کنید تا نسخه بعد یه دامنه پیشفرض دیگه داخل برنامه قرار بدم
