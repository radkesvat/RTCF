...
case $(uname -m) in
    x86_64)  URL="https://github.com/radkesvat/RTCF/releases/download/V1.3/RTCF_ST_AMD-1.3.zip" ;;
    arm)     URL="https://github.com/radkesvat/RTCF/releases/download/V1.3/RTCF_ST_AMD-1.3.zip" ;;
    aarch64) URL="https://github.com/radkesvat/RTCF/releases/download/V1.3/RTCF_ST_AMD-1.3.zip" ;;
...
wget  $URL -O RTCF_ST_AMD-1.3.zip
unzip -o RTCF_ST_AMD-1.3.zip
chmod +x RTCF
rm RTCF_ST_AMD-1.3.zip
