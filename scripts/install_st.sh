...
case $(uname -m) in
    x86_64)  URL="https://github.com/radkesvat/RTCF/releases/download/V2.1/RTCF_ST_AMD-2.1.zip" ;;
    arm)     URL="https://github.com/radkesvat/RTCF/releases/download/V2.1/RTCF_ST_AMD-2.1.zip" ;;
    aarch64) URL="https://github.com/radkesvat/RTCF/releases/download/V2.1/RTCF_ST_AMD-2.1.zip" ;;
...
wget  $URL -O RTCF_ST_AMD-2.1.zip
unzip -o RTCF_ST_AMD-2.1.zip
chmod +x RTCF
rm RTCF_ST_AMD-2.1.zip
