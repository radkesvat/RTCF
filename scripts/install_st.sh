...
case $(uname -m) in
    x86_64)  URL="https://github.com/radkesvat/RTCF/releases/download/V2.0/RTCF_ST_AMD-2.0.zip" ;;
    arm)     URL="https://github.com/radkesvat/RTCF/releases/download/V2.0/RTCF_ST_AMD-2.0.zip" ;;
    aarch64) URL="https://github.com/radkesvat/RTCF/releases/download/V2.0/RTCF_ST_AMD-2.0.zip" ;;
...
wget  $URL -O RTCF_ST_AMD-2.0.zip
unzip -o RTCF_ST_AMD-2.0.zip
chmod +x RTCF
rm RTCF_ST_AMD-2.0.zip
