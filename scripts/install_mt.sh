...
case $(uname -m) in
    x86_64)  URL="https://github.com/radkesvat/RTCF/releases/download/V1.8/RTCF_MT_AMD-1.8.zip" ;;
    arm)     URL="https://github.com/radkesvat/RTCF/releases/download/V1.8/RTCF_MT_AMD-1.8.zip" ;;
    aarch64) URL="https://github.com/radkesvat/RTCF/releases/download/V1.8/RTCF_MT_AMD-1.8.zip" ;;
...
wget  $URL -O RTCF_MT_AMD-1.8.zip
unzip -o RTCF_MT_AMD-1.8.zip
chmod +x RTCF
rm RTCF_MT_AMD-1.8.zip
