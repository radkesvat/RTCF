...
case $(uname -m) in
    x86_64)  URL="https://github.com/radkesvat/RTCF/releases/download/V0.3/RTCF_MT_AMD-0.3.zip" ;;
    arm)     URL="https://github.com/radkesvat/RTCF/releases/download/V0.3/RTCF_MT_AMD-0.3.zip" ;;
    aarch64) URL="https://github.com/radkesvat/RTCF/releases/download/V0.3/RTCF_MT_AMD-0.3.zip" ;;
...
wget  $URL -O RTCF_MT_AMD-0.3.zip
unzip -o RTCF_MT_AMD-0.3.zip
chmod +x RTCF
rm RTCF_MT_AMD-0.3.zip
