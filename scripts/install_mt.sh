...
case $(uname -m) in
    x86_64)  URL="https://github.com/radkesvat/RTCF/releases/download/V0.1/RTCF_MT_AMD-0.2.zip" ;;
    arm)     URL="https://github.com/radkesvat/RTCF/releases/download/V0.1/RTCF_MT_AMD-0.2.zip" ;;
    aarch64) URL="https://github.com/radkesvat/RTCF/releases/download/V0.1/RTCF_MT_AMD-0.2.zip" ;;
